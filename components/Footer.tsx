    ...
    <footer className="bg-gray-900">
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="lg:flex lg:items-start lg:gap-8">
          <div className="text-teal-600 dark:text-amber-500">
            ...
            <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
              <form className="w-full">
                ...
                >
                  ...
                  <button
                    className="mt-1 w-full bg-amber-500 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-amber-600 sm:mt-0 sm:w-auto sm:shrink-0"
                  >
                    Sign Up
                  </button>
                </div>
